    ...
    run(out, argv) {
        ...
        for (let rawArg of argv) {
            if (pendingOpt !== null) {
                ...
                if (pendingOpt instanceof SpecialOption && pendingOpt.invoke(this, out, optArg)) {
                    return;
                }
                    ...
                    if (optShortNames.has(optName)) {
                        ...
                        if (opt.arg !== null) {
                            if (optArgStr !== undefined && optArgStr.length > 0) {
                                ...
                                if (opt instanceof SpecialOption && opt.invoke(this, out, optArg)) {
                                    return;
                                }
                                optVals[normOptName] = optArg;
                            }
                                ...
                                if (opt.arg instanceof option.OptionalOptionArgument) {
                                    if (opt instanceof SpecialOption && opt.invoke(this, out, opt.arg.defaultVal)) {
                                        return;
                                    }
                            ...
                            if (opt instanceof SpecialOption && opt.invoke(this, out, true)) {
                                return;
                            }
...
class SpecialOption extends option.Option {
    ...
    /**
     * Returns whether the option is a special option or not.
