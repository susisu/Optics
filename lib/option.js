...
class Option {
    ...
    /**
     * Returns descriptor string of the option.
     * @returns {string} Descriptor string.
     */
    toDescriptor() {
        let list = [];
        if (this.shortName !== undefined) {
            list.push("-" + this.shortName + (this.arg !== null ? this.arg.toShortPlaceholder() : ""));
        }
        if (this.longName !== undefined) {
            list.push("--" + this.longName + (this.arg !== null ? this.arg.toLongPlaceholder() : ""));
        }
        return list.join(", ");
    }
}
